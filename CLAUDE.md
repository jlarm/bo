...
- `composer run test` - Run full test suite (includes lint, refactor, types, coverage)
...
This is a Laravel 12 application with a modern stack:

### Frontend Architecture
- **Livewire 3** for reactive components
- **Livewire Volt** for single-file components (class-based and functional)
...
- Volt components for pages requiring interactivity (this project uses Volt for new interactive pages)
- Flux UI components provide the design system
- Layout components in `resources/views/components/layouts/`

### Authentication & Settings
- Built-in Laravel authentication with Livewire components
- Settings pages for profile, password, and appearance management
- User settings accessible at `/settings/*` routes

### Key Architectural Decisions
- Uses Laravel 12's streamlined structure (no `app/Http/Middleware/` directory)
- Components follow the App\Livewire namespace pattern
- Tests use Pest framework with comprehensive coverage requirements
- Code quality enforced through Pint, Rector, and PHPStan
